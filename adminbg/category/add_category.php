                            ...
                            <div class="form">
                                <form action="" method="post" name="myform">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" onkeyup="checkAvailability()" class="form-control" required name="category" id="category" ng-model="user.category" ng-required="true" placeholder="Enter category name">
                                            <span id="category_availability"></span> 
      <p ng-show="myform.category.$invalid && myform.category.$touched" class="form_error_msg error">This field is must not be empty !!!</p>
                                        </div>
                                    </div>
                                    <div class="form-group">
